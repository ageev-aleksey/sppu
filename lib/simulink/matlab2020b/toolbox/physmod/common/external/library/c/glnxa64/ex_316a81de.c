...
n3,const size_t n4,const boolean_T ex_F_tm5fod4xxuguhS49BSQm,const boolean_T
ex_kMAXUIgm88xvaunhJ2st8X);static void ex_VsRYme4f6atlj9wrOKGZwp(real_T*x1,
real_T*x2,real_T*x3,real_T*x4,real_T*f,const real_T*x1s,const real_T*x2s,const
real_T*x3s,const real_T*x4s,const real_T*fs,const size_t n1,const size_t n2,
const size_t n3,const size_t n4);void tlu2_4d_linear_nearest_process(real_T*x1
,real_T*x2,real_T*x3,real_T*x4,real_T*f,const real_T*x1s,const real_T*x2s,
const real_T*x3s,const real_T*x4s,const real_T*fs,const size_t*n1,const size_t
*n2,const size_t*n3,const size_t*n4){ex_VsRYme4f6atlj9wrOKGZwp(x1,x2,x3,x4,f,
x1s,x2s,x3s,x4s,fs,*n1,*n2,*n3,*n4);}void
tlu2_4d_linear_nearest_process_custom_function_(void*out,const void*in){const
...
x3,real_T*x4,real_T*f,const real_T*x1s,const real_T*x2s,const real_T*x3s,const
real_T*x4s,const real_T*fs,const size_t*n1,const size_t*n2,const size_t*n3,
const size_t*n4){ex_VsRYme4f6atlj9wrOKGZwp(x1,x2,x3,x4,f,x1s,x2s,x3s,x4s,fs,*
n1,*n2,*n3,*n4);}void tlu2_4d_linear_linear_process_custom_function_(void*out,
...
real_T*x2,real_T*x3,real_T*x4,real_T*f,const real_T*x1s,const real_T*x2s,const
real_T*x3s,const real_T*x4s,const real_T*fs,const size_t n1,const size_t n2,
const size_t n3,const size_t n4){const size_t n=n1*n2*n3*n4;memcpy(x1,x1s,n1*
...
size_t*n4){ex__XRlFJBXKftbhDMccAS5ma(fi,H1,G1,*bin1,H2,G2,*bin2,H3,G3,*bin3,H4
,G4,*bin4,f,*n1,*n2,*n3,*n4,false,false);}void
...
H4=(const real_T*)((const void*const*)in)[9];const real_T*G4=(const real_T*)((
const void*const*)in)[10];const size_t*bin4=(const size_t*)((const void*const*
)in)[11];const real_T*f=(const real_T*)((const void*const*)in)[12];const size_t
*n1=(const size_t*)((const void*const*)in)[13];const size_t*n2=(const size_t*)
((const void*const*)in)[14];const size_t*n3=(const size_t*)((const void*const*
)in)[15];const size_t*n4=(const size_t*)((const void*const*)in)[16];real_T*fi=
(real_T*)out;tlu2_4d_linear_nearest_value(fi,H1,G1,bin1,H2,G2,bin2,H3,G3,bin3,
H4,G4,bin4,f,n1,n2,n3,n4);}void tlu2_4d_linear_linear_value(real_T*fi,const
...
H1,G1,*bin1,H2,G2,*bin2,H3,G3,*bin3,H4,G4,*bin4,f,*n1,*n2,*n3,*n4,true,false);
}void tlu2_4d_linear_linear_value_custom_function_(void*out,const void*in){
...
*H4=(const real_T*)((const void*const*)in)[9];const real_T*G4=(const real_T*)(
(const void*const*)in)[10];const size_t*bin4=(const size_t*)((const void*const
*)in)[11];const real_T*f=(const real_T*)((const void*const*)in)[12];const
size_t*n1=(const size_t*)((const void*const*)in)[13];const size_t*n2=(const
size_t*)((const void*const*)in)[14];const size_t*n3=(const size_t*)((const void
*const*)in)[15];const size_t*n4=(const size_t*)((const void*const*)in)[16];
real_T*fi=(real_T*)out;tlu2_4d_linear_linear_value(fi,H1,G1,bin1,H2,G2,bin2,H3
,G3,bin3,H4,G4,bin4,f,n1,n2,n3,n4);}void tlu2_4d_linear_nearest_derivatives(
real_T*fi,const real_T*H1,const real_T*G1,const size_t*bin1,const real_T*H2,
const real_T*G2,const size_t*bin2,const real_T*H3,const real_T*G3,const size_t
*bin3,const real_T*H4,const real_T*G4,const size_t*bin4,const real_T*f,const
size_t*n1,const size_t*n2,const size_t*n3,const size_t*n4){
ex__XRlFJBXKftbhDMccAS5ma(fi,H1,G1,*bin1,H2,G2,*bin2,H3,G3,*bin3,H4,G4,*bin4,f
,*n1,*n2,*n3,*n4,false,true);}void
tlu2_4d_linear_nearest_derivatives_custom_function_(void*out,const void*in){
const real_T*H1=(const real_T*)((const void*const*)in)[0];const real_T*G1=(
const real_T*)((const void*const*)in)[1];const size_t*bin1=(const size_t*)((
const void*const*)in)[2];const real_T*H2=(const real_T*)((const void*const*)in
)[3];const real_T*G2=(const real_T*)((const void*const*)in)[4];const size_t*
...
size_t*)((const void*const*)in)[14];const size_t*n3=(const size_t*)((const void
*const*)in)[15];const size_t*n4=(const size_t*)((const void*const*)in)[16];
real_T*fi=(real_T*)out;tlu2_4d_linear_nearest_derivatives(fi,H1,G1,bin1,H2,G2,
bin2,H3,G3,bin3,H4,G4,bin4,f,n1,n2,n3,n4);}void
...
real_T*H3,const real_T*G3,const size_t*bin3,const real_T*H4,const real_T*G4,
const size_t*bin4,const real_T*f,const size_t*n1,const size_t*n2,const size_t*
n3,const size_t*n4){ex__XRlFJBXKftbhDMccAS5ma(fi,H1,G1,*bin1,H2,G2,*bin2,H3,G3
,*bin3,H4,G4,*bin4,f,*n1,*n2,*n3,*n4,true,true);}void
...
size_t*)((const void*const*)in)[14];const size_t*n3=(const size_t*)((const void
*const*)in)[15];const size_t*n4=(const size_t*)((const void*const*)in)[16];
real_T*fi=(real_T*)out;tlu2_4d_linear_linear_derivatives(fi,H1,G1,bin1,H2,G2,
bin2,H3,G3,bin3,H4,G4,bin4,f,n1,n2,n3,n4);}static void
ex__XRlFJBXKftbhDMccAS5ma(real_T*fi,const real_T*H1,const real_T*G1,const
size_t bin1,const real_T*H2,const real_T*G2,const size_t bin2,const real_T*H3,
const real_T*G3,const size_t bin3,const real_T*H4,const real_T*G4,const size_t
bin4,const real_T*f,const size_t n1,const size_t n2,const size_t n3,const
size_t n4,const boolean_T ex_V0dauSHHy5d6_D42s3Aeag,const boolean_T
ex_kMAXUIgm88xvaunhJ2st8X){size_t ex_FQ8I1Oq4CShSeySHdok3C7=n1*n2;size_t
...
ex_Fz136CeCPW_CcPzKpIHjrJ=0;ex_Fz136CeCPW_CcPzKpIHjrJ<2;++
