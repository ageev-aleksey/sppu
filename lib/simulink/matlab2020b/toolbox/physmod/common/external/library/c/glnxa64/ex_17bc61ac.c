...
const real_T*t,const size_t*n){*bin=ex_VzC4wVDNwRO2VyQZ1TOBFP(H,G,x,*n,*t,true
);}void tlu2_linear_linear_prelookup_custom_function_(void*out,const void*in){
const real_T*x=(const real_T*)((const void*const*)in)[0];const real_T*t=(const
real_T*)((const void*const*)in)[1];const size_t*n=(const size_t*)((const void*
const*)in)[2];real_T*H=(real_T*)((void**)out)[0];real_T*G=(real_T*)((void**)
out)[1];size_t*bin=(size_t*)((void**)out)[2];tlu2_linear_linear_prelookup(H,G,
bin,x,t,n);}void tlu2_linear_nearest_prelookup(real_T*H,real_T*G,size_t*bin,
const real_T*x,const real_T*t,const size_t*n){*bin=ex_VzC4wVDNwRO2VyQZ1TOBFP(H
,G,x,*n,*t,false);}void tlu2_linear_nearest_prelookup_custom_function_(void*
out,const void*in){const real_T*x=(const real_T*)((const void*const*)in)[0];
const real_T*t=(const real_T*)((const void*const*)in)[1];const size_t*n=(const
size_t*)((const void*const*)in)[2];real_T*H=(real_T*)((void**)out)[0];real_T*G
=(real_T*)((void**)out)[1];size_t*bin=(size_t*)((void**)out)[2];
tlu2_linear_nearest_prelookup(H,G,bin,x,t,n);}void tlu2_akima_linear_prelookup
(real_T*basis,real_T*basisDerivative,size_t*bin,const real_T*x,const real_T*t,
const size_t*n){*bin=ex_F0HBEJ7qD9OkfDK6FdP9lf(basis,basisDerivative,x,*n,*t,1
);}void tlu2_akima_linear_prelookup_custom_function_(void*out,const void*in){
const real_T*x=(const real_T*)((const void*const*)in)[0];const real_T*t=(const
real_T*)((const void*const*)in)[1];const size_t*n=(const size_t*)((const void*
const*)in)[2];real_T*basis=(real_T*)((void**)out)[0];real_T*basisDerivative=(
real_T*)((void**)out)[1];size_t*bin=(size_t*)((void**)out)[2];
tlu2_akima_linear_prelookup(basis,basisDerivative,bin,x,t,n);}void
tlu2_akima_nearest_prelookup(real_T*basis,real_T*basisDerivative,size_t*bin,
const real_T*x,const real_T*t,const size_t*n){*bin=ex_F0HBEJ7qD9OkfDK6FdP9lf(
basis,basisDerivative,x,*n,*t,0);}void
tlu2_akima_nearest_prelookup_custom_function_(void*out,const void*in){const
...
)in)[2];real_T*basis=(real_T*)((void**)out)[0];real_T*basisDerivative=(real_T*
)((void**)out)[1];size_t*bin=(size_t*)((void**)out)[2];
tlu2_akima_nearest_prelookup(basis,basisDerivative,bin,x,t,n);}
