...
ex_F4J173IGY_hgXaf_WD6AOj(real_T*fi,const real_T*basis,const real_T*
basisDerivative,const size_t bin,const real_T*fx,const size_t n,const size_t
ex_F_tm5fod4xxuguhS49BSQm,const boolean_T ex_kMAXUIgm88xvaunhJ2st8X,const
real_T*work1,const size_t*work2);static void ex_kYk7SswBvLtHbmZRWvRMEh(real_T*
x,real_T*fx,const real_T*xs,const real_T*fs,const size_t n);void
...
tlu2_1d_akima_nearest_value(real_T*fi,const real_T*basis,const real_T*
basisDerivative,const size_t*bin,const real_T*fx,const size_t*n,const real_T*
work1,const size_t*work2){ex_F4J173IGY_hgXaf_WD6AOj(fi,basis,basisDerivative,*
bin,fx,*n,0,false,work1,work2);}void
tlu2_1d_akima_nearest_value_custom_function_(void*out,const void*in){const
real_T*basis=(const real_T*)((const void*const*)in)[0];const real_T*
basisDerivative=(const real_T*)((const void*const*)in)[1];const size_t*bin=(
const size_t*)((const void*const*)in)[2];const real_T*fx=(const real_T*)((
const void*const*)in)[3];const size_t*n=(const size_t*)((const void*const*)in)
[4];const real_T*work1=(const real_T*)((const void*const*)in)[5];const size_t*
work2=(const size_t*)((const void*const*)in)[6];real_T*fi=(real_T*)out;
tlu2_1d_akima_nearest_value(fi,basis,basisDerivative,bin,fx,n,work1,work2);}
void tlu2_1d_akima_linear_value(real_T*fi,const real_T*basis,const real_T*
basisDerivative,const size_t*bin,const real_T*fx,const size_t*n,const real_T*
work1,const size_t*work2){ex_F4J173IGY_hgXaf_WD6AOj(fi,basis,basisDerivative,*
bin,fx,*n,1,false,work1,work2);}void
tlu2_1d_akima_linear_value_custom_function_(void*out,const void*in){const
real_T*basis=(const real_T*)((const void*const*)in)[0];const real_T*
basisDerivative=(const real_T*)((const void*const*)in)[1];const size_t*bin=(
const size_t*)((const void*const*)in)[2];const real_T*fx=(const real_T*)((
const void*const*)in)[3];const size_t*n=(const size_t*)((const void*const*)in)
[4];const real_T*work1=(const real_T*)((const void*const*)in)[5];const size_t*
work2=(const size_t*)((const void*const*)in)[6];real_T*fi=(real_T*)out;
tlu2_1d_akima_linear_value(fi,basis,basisDerivative,bin,fx,n,work1,work2);}
void tlu2_1d_akima_nearest_derivatives(real_T*fi,const real_T*basis,const
real_T*basisDerivative,const size_t*bin,const real_T*fx,const size_t*n,const
real_T*work1,const size_t*work2){ex_F4J173IGY_hgXaf_WD6AOj(fi,basis,
basisDerivative,*bin,fx,*n,0,true,work1,work2);}void
tlu2_1d_akima_nearest_derivatives_custom_function_(void*out,const void*in){
const real_T*basis=(const real_T*)((const void*const*)in)[0];const real_T*
basisDerivative=(const real_T*)((const void*const*)in)[1];const size_t*bin=(
const size_t*)((const void*const*)in)[2];const real_T*fx=(const real_T*)((
const void*const*)in)[3];const size_t*n=(const size_t*)((const void*const*)in)
[4];const real_T*work1=(const real_T*)((const void*const*)in)[5];const size_t*
work2=(const size_t*)((const void*const*)in)[6];real_T*fi=(real_T*)out;
tlu2_1d_akima_nearest_derivatives(fi,basis,basisDerivative,bin,fx,n,work1,
work2);}void tlu2_1d_akima_linear_derivatives(real_T*fi,const real_T*basis,
const real_T*basisDerivative,const size_t*bin,const real_T*fx,const size_t*n,
const real_T*work1,const size_t*work2){ex_F4J173IGY_hgXaf_WD6AOj(fi,basis,
basisDerivative,*bin,fx,*n,1,true,work1,work2);}void
...
[4];const real_T*work1=(const real_T*)((const void*const*)in)[5];const size_t*
work2=(const size_t*)((const void*const*)in)[6];real_T*fi=(real_T*)out;
tlu2_1d_akima_linear_derivatives(fi,basis,basisDerivative,bin,fx,n,work1,work2
);}static void ex_F4J173IGY_hgXaf_WD6AOj(real_T*fi,const real_T*
ex_Vl61InPOzylYgiebES6ELs,const real_T*ex_FMWNpeuUHEGegPasHZICvW,const size_t
bin,const real_T*ex_VorZCi5_B5tOa9oe3bnRf5,const size_t n,const size_t
ex_F_tm5fod4xxuguhS49BSQm,const boolean_T ex_kMAXUIgm88xvaunhJ2st8X,const
real_T*work1,const size_t*work2){const size_t ex_F3nVSXkoDK8VeeL5OmY0_B=1;
const real_T**ex_kB4aOAnByNCbf5JZPcoQy5=0;const real_T**
ex_FNyrrBDfkJhIjyNSa2fMBz=0;const size_t ex__NJXN1LXJ3dhZPDo3_p2LH=1;real_T*
basis[1];real_T*basisDerivative[1];size_t ex__I2IEgdElv80cD1Kv0uRpM[1];size_t*
ex_Vic4f_t1_8lMdPxTHOuua8[1];real_T*ex_V1PpSt9JShK3bL1Bw6asF1;size_t*
ex_VVfVnPxpzepMZXSq9ZSsjY;basis[0]=ex_VQMmQUcKA3_3ei3Owj7WVV(
ex_Vl61InPOzylYgiebES6ELs);basisDerivative[0]=ex_VQMmQUcKA3_3ei3Owj7WVV(
ex_FMWNpeuUHEGegPasHZICvW);ex__I2IEgdElv80cD1Kv0uRpM[0]=bin;
ex_Vic4f_t1_8lMdPxTHOuua8[0]=ex__I2IEgdElv80cD1Kv0uRpM;
ex_V1PpSt9JShK3bL1Bw6asF1=ex_VQMmQUcKA3_3ei3Owj7WVV(work1);
ex_VVfVnPxpzepMZXSq9ZSsjY=ex__ge8CPdYTqKVfmxfN0MdXT(work2);if(!
ex_kMAXUIgm88xvaunhJ2st8X){ex__I__tR3HVGtUdmAFtUcU_G(ex_F3nVSXkoDK8VeeL5OmY0_B
,&n,ex_kB4aOAnByNCbf5JZPcoQy5,ex_F_tm5fod4xxuguhS49BSQm+1,
...
&fi[0]);}else{ex__I__tR3HVGtUdmAFtUcU_G(ex_F3nVSXkoDK8VeeL5OmY0_B,&n,
ex_kB4aOAnByNCbf5JZPcoQy5,ex_F_tm5fod4xxuguhS49BSQm+1,
ex_VQMmQUcKA3_3ei3Owj7WVV(ex_VorZCi5_B5tOa9oe3bnRf5),basisDerivative,&
ex_V1PpSt9JShK3bL1Bw6asF1[0],&ex_VVfVnPxpzepMZXSq9ZSsjY[0],
ex__NJXN1LXJ3dhZPDo3_p2LH,ex_FNyrrBDfkJhIjyNSa2fMBz,ex_Vic4f_t1_8lMdPxTHOuua8,
&fi[0]);}}
