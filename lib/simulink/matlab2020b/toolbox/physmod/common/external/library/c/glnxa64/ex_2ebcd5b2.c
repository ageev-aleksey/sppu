...
*ex_F1rQUll_EnhbfeQZPiHn_s);real_T*ex_VQMmQUcKA3_3ei3Owj7WVV(const real_T*x){
...
real_T*basisDerivative,const real_T*x,const size_t n,const real_T t,const
size_t ex_F_tm5fod4xxuguhS49BSQm){const size_t ex_kZcS4HYHCeCHdyUHoTP_e5=1;
const size_t ex_Vltq01gye14eeeDsro_AVI=0;const size_t ex__NJXN1LXJ3dhZPDo3_p2LH
=1;size_t bin;ex_k3a7efHitoCaVqpYN7YToy(x,n,ex__NJXN1LXJ3dhZPDo3_p2LH,&t,&bin)
;ex_VUv5qERYa5OL_DZXviEVuZ(x,n,ex_F_tm5fod4xxuguhS49BSQm+1,
ex_kZcS4HYHCeCHdyUHoTP_e5,ex__NJXN1LXJ3dhZPDo3_p2LH,&t,&bin,basis);
ex_VUv5qERYa5OL_DZXviEVuZ(x,n,ex_F_tm5fod4xxuguhS49BSQm+1,
ex_Vltq01gye14eeeDsro_AVI,ex__NJXN1LXJ3dhZPDo3_p2LH,&t,&bin,basisDerivative);
return bin;}
